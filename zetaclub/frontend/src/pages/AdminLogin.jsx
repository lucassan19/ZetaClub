...
const AdminLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      console.log(
        "Enviando tentativa de login para:",
    ...
    <div className="flex flex-col justify-center items-center py-12 md:py-24 px-4">
      <div className="mb-10 text-center">
        ...
        <h1 className="text-4xl font-black text-white tracking-tighter">
          67<span className="text-primary-500">videos</span> Admin
        </h1>
        <p className="text-slate-500 font-medium mt-2">
          Área restrita para gestão de conteúdo.
        </p>
      </div>
        ...
        <form onSubmit={handleLogin} className="space-y-8">
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              />
              <User
                className="absolute left-4 top-4 text-slate-500 group-focus-within:text-primary-500 transition-colors"
                size={20}
              />
            </div>
          </div>
      ...
      <p className="mt-12 text-slate-600 text-sm font-bold flex items-center gap-2">
        <ShieldCheck size={16} />
        Sistema de Segurança 67videos v2.0
      </p>
    </div>
  );
};
